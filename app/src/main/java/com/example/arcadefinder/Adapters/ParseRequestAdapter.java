...
public class ParseRequestAdapter extends RecyclerView.Adapter<ParseRequestAdapter.ViewHolder> {

    Context context;
    List<ParseGameLocation> requests;

    public ParseRequestAdapter(Context context, List<ParseGameLocation> posts) {
